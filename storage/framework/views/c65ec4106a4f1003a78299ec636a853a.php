...
btn-outline-light my-2 ms-md-auto"><i
    ...
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('employees.store')); ?>" class="needs-validation was-validated" method="POST" novalidate="">
            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\ITTELKOM\KULIAH\Semester 6\Pemrograman Framework\Tugas\praktikum5\modul4\resources\views/employees/create.blade.php ENDPATH**/ ?>